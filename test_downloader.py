...
class TestDownloader(unittest.TestCase):
    ...
    def test_image_url(self):
        self.assertEqual("http://arc.bato.to/comics/i/iris-zero/02/ala-atra/English/" + \
    ...
    def test_next_page_url(self):
        self.assertEqual("http://bato.to/read/_/1496/iris-zero_v1_ch2_by_ala-atra-scans/2",
                         self.downloader.get_next_page_url(self.soup))

    def test_next_chapter_url(self):
        self.assertEqual("http://bato.to/read/_/703/iris-zero_v1_ch3_by_ala-atra-scans",
